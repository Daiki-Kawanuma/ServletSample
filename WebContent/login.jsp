        ...
        <form-wrapper>
            ...
            <div class = hako>
                ...
                <label for="account_number"></label>
                 <input type="text" name="account_number" required="required " placeholder=口座番号を入力してください。>
                </input>
                </div>
                 <div class = "form-item">
                <input type="password" name="login_pass" required="required" placeholder=パスワードを入力してください。>
                 </input>
                </div>
