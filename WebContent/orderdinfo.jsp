...
<body>
	...
	<table border=1>
		...
		<tr><td><%=o.getReceptionNumber() %></td><td><%=o.getBrand() %></td><td><%=o.getBrand().getBrandCode() %></td><td><%=o.getBrand().getmarketPrice() %></td></tr>
		...
		<tr><td><%=o.getClosingDate() %></td><td><%= %></td><td><%=o.getClosingUnitPrice() %></td><td><%=  o.getClosingUnitPrice()%></td></tr>
