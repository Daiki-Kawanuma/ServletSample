...
<body>
	...
	<table border=1>
		...
		<tr><td><%=o.getReceptionNumber() %></td><td><%=o.getOrderStatus()  o.getBrand() %></td><td><%=o.getBrand().getBrandCode() %></td><td><%=o.getBrand().getMarketPrice() %></td></tr>
		...
		<tr><td><%=o.getClosingDate() %></td><td><%=o.getClosingAmount() %></td><td><%=o.getClosingUnitPrice() %></td><td><%=getClosingAmount() * o.getClosingUnitPrice()%></td></tr>
